...
class EmployeeAttendanceWindow:
    ...
    def update_frame(self):
        ...
        cv2.putText(frame, f"Date: {date_str}", (10, 55),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 0), 2)

        cv2.putText(frame, f"Time: {time_str}", (10, 85),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 255), 2)

        # OPENCV → TKINTER IMAGE CONVERSION
    ...
    # ----------------------------------------------------------
    # MARK ATTENDANCE WHEN USER CLICKS
    # ----------------------------------------------------------
